...
test.describe('Flipkart Washing Machine Add to Cart', () => {
  test('should search washing machine, extract details and verify cart', async ({ page }) => {
    ...
    // Verify product price in cart matches the selected product price
    ...
    // Log all captured data (product details + cart verification)
    console.log('\n========== COMPLETE TEST DATA ==========');
    console.log('\n--- PRODUCT DETAILS ---');
    console.log('Product Name:', capturedProductName);
    console.log('Product Price:', capturedProductPrice);
    ...
    console.log('Product Present in Cart:', (cartProductName && cartProductPrice) ? 'YES ✓' : 'NO ✗');
    console.log('\n--- TEST STATUS ---');
