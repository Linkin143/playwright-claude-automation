...
// ─────────────────────────────────────────────────────────────────────────────
// HELPER : Close Flipkart login popup if visible
// ─────────────────────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────────────────────
// HELPER : Return trimmed innerText for the first matching element, or 'N/A'
// ─────────────────────────────────────────────────────────────────────────────
async function safeText(page: Page, selector: string): Promise<string> {
  ...
  } catch { /* swallow – element simply not found */ }
  return 'N/A';
}
...
test.describe('Flipkart – Washing Machine Search & Add to Cart', () => {
  ...
  test('Search washing machine, open first product, add to cart, verify cart', async ({ browser }) => {
    ...
    console.log('[Step 5] Search results are visible.');

    // ── STEP 6 : Locate the first product card link ──────────────────────────
    ...
    // ── STEP 7 : Click product — handle same-tab or new-tab navigation ───────
